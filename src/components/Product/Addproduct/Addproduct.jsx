...
const Addproduct = () => {
  ...
  const [materialp, setMaterialp] = useState("");
  const [transportation, setTransportation] = useState("");
  const [transportationp, setTransportationp] = useState("");
  const [fabricp, setFabricp] = useState("");
  const [garmentp, setGarmentp] = useState("");
            ...
            <div className="data_container_resell">
              ...
              <div className="details_con manufact">
                ...
                <input
                  className="border"
                  type="text"
                  placeholder="Sewing yarn content and percent"
                  value={swing}
              ...
              <div className="details_con">
                <textarea
                  ...
                  cols="30"
                  rows="3"
                  placeholder="Traceability description"
              ...
              <div className="details_con">
                <textarea
                  ...
                  cols="30"
                  rows="2"
                  placeholder="Embroidery Threads"
                  value={embroidery}
              ...
              <div className="details_con">
                <textarea
                  ...
                  cols="30"
                  rows="3"
                  placeholder="Manufacturer's certifications"
              ...
              <div className="details_con sus">
                <input
                  className="border"
                  type="text"
                  placeholder="Material Cultivation"
                  value={eimmision}
              ...
              <div className="details_con sus">
                <input
                  ...
                  value={materialp}
                  onChange={(e) => setMaterialp(e.target.value)}
                />
                ...
                <input
                  ...
                  placeholder="Fabric %"
                  value={fabricp}
                  onChange={(e) => setFabricp(e.target.value)}
                />
                ...
                <input
                  ...
                  placeholder="Garment %"
                  value={garmentp}
                  onChange={(e) => setGarmentp(e.target.value)}
                />
              </div>
              <div className="details_con sus">
                <input
                  ...
                  type="text"
                  placeholder="Transportation %"
                  value={transportationp}
                  onChange={(e) => setTransportationp(e.target.value)}
                />
              </div>
