...
const Addproduct = () => {
    ...
    const upload = ()=>{
        ...
        firebase.addProduct(productid,productName,size,type,color,details,footprint,eimmision,water,waste,fibric,manufacturere,city,images
            ...
            washcare,certifications,manufacility,country,origin,price,sizeSystem,releaseDate,footprintoverall,Basicdetails
            ).then(()=>{
            alert("Product Added");
            setparentOrg('');
            setGender('');
            ...
            <div className="resell_container">
                ...
                <div className="text_container_resell">
                    ...
                    <div className="data_container_resell">
                        ...
                        <div className="details_con">
                            <textarea name="" id="" cols="30" rows="5" placeholder='Basic details'
                            value={Basicdetails}
