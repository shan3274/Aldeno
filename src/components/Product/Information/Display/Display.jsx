    ...
    if(myarr[0] == 'Product'){
        ...
        <div className="sub_sustain">
            ...
            <div className="carbon_foot">
                <p><span className="emi">Your Total emission</span><br/>{props.footprintoverall} <br/><span>KG  CO <sub>2</sub>e</span></p>
            </div>
            <div className="nor_data data1">
                <p>{props.eimmision}<br/><span>Kg CO<sub>2</sub> of emission abated by using BMP Cotton</span></p>
            </div>
            <div className="nor_data data2">
                <p>{props.water}<br/><span>Grams of waste deliverd from land fill</span></p>
            </div>
            <div className="nor_data data3">
                <p>{props.waste}<br/><span>Grams of CO<sub>2</sub> emission per garment by recyling of fabric waste</span></p>
            </div>
        </div>
    </div>
          )
