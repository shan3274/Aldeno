            ...
            <div className="basicdetails scroll">
                <div className="detailsection">
                    <div className="sectone">
                        ...
                        <div className="btns">
                            <div className="btnopt">
                                <Link to='/displaydata' state={'Product Background '+props.productid}><button onClick={vis}>Product Background +</button></Link>
                            </div>
                            <div className="btnopt">
                                <Link to='/displaydata' state={'Traceability '+props.productid}><button onClick={vis}>Traceability +</button></Link>                      
                            </div>
                            <div className="btnopt">
                                <Link to='/displaydata' state={'Sustainability '+props.productid}><button onClick={vis}>Sustainability +</button></Link>                         
                            </div>
                            <div className="btnopt">
                                <Link to='/displaydata' state={'Resell & Recycle '+props.productid}><button onClick={vis}>Resell & Recycle +</button></Link>
                            </div>
                        </div>
                        <div className="aldeno_logo ref">
                            <Link to={'/product/'+props.productid} onClick={refresh}>Refresh</Link>
                        </div>
                        <div className="aldeno_logo">
                            <a href="https://aldeno.in/">aldeno.in</a>
                        </div>
